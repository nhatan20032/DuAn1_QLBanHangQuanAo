...
namespace _3.PL.View
{
    public partial class FrmKhachHang : Form
    {
        ...
        {
            if (txt_Cmnd.Text == "" || txt_diaChi.Text == "" || txt_Ho.Text == "" || txt_Ma.Text == "" || txt_sdt.Text == "" || txt_ten.Text == "" ) return false;
            return true;
        }
        private void btn_THEM_Click(object sender, EventArgs e)
        {
            var p = _khachHangServices.GetAll().FirstOrDefault(x => x.Ma == txt_Ma.Text);
            if (checknhap() == false)
            {
        ...
        {
            Utilities.checkChu(txt_Cmnd.Text);
        }

        private void txt_sdt_TextChanged(object sender, EventArgs e)
        {
            Utilities.CheckSDT(txt_sdt.Text);
        }

        private void txt_thanhPho_TextChanged(object sender, EventArgs e)
        {
            Utilities.CheckSo(txt_thanhPho.Text);
        }
    }
}
